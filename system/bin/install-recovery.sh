#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/platform/11120000.ufs/by-name/RECOVERY:43780384:98ec1a352eca1a181d838ef76f9ad347638a1b50; then
  applypatch EMMC:/dev/block/platform/11120000.ufs/by-name/BOOT:37351712:a646daa02e7cef2df58e75d9aa61d1714695f23f EMMC:/dev/block/platform/11120000.ufs/by-name/RECOVERY 98ec1a352eca1a181d838ef76f9ad347638a1b50 43780384 a646daa02e7cef2df58e75d9aa61d1714695f23f:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
